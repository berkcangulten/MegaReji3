...
public class SSShowActorPostClass extends ArrayAdapter<String> {
    ...
    public SSShowActorPostClass(ArrayList<String> name, ArrayList<String>id,ArrayList<String> wayofsetArray,ArrayList<String> wayofsceneArray, Activity context){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent3 = new Intent(context.getApplicationContext(),SSShowActorEnd.class);
