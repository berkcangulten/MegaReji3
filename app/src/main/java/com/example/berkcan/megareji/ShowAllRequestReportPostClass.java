...
public class ShowAllRequestReportPostClass extends ArrayAdapter<String> {
    ...
    //Constructor
    public ShowAllRequestReportPostClass(ArrayList<String>name,ArrayList<String>id,Activity context){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent3 = new Intent(context.getApplicationContext(),ShowAllRequestReportEnd.class);
