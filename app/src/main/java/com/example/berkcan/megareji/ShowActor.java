...
public class ShowActor extends AppCompatActivity {
    ...
    ActorPostClass customAdapter;
    ListView listviewShowActor;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_actor);
        listviewShowActor=findViewById(R.id.listviewShowActor);
        ...
        customAdapter=new ActorPostClass(name,ids,this);
        listviewShowActor.setAdapter(customAdapter);
        getDataFromFirebase();

        listviewShowActor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
