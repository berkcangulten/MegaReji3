...
public class SetListPostClass extends ArrayAdapter<String> {
    private final ArrayList<String> email;
    private final ArrayList<String> id ;
    private final Activity context;

    public SetListPostClass(ArrayList<String>email,ArrayList<String>id,Activity context){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent3 = new Intent(context.getApplicationContext(),SceneList.class);
                intent3.putExtra("id",id.get(position)); //Send unique ID of set
